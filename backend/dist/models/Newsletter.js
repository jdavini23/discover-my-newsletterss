...
exports.Newsletter = exports.NewsletterFrequency = void 0;
...
(function (NewsletterFrequency) {
    ...
    NewsletterFrequency["QUARTERLY"] = "quarterly";
})(NewsletterFrequency || (exports.NewsletterFrequency = NewsletterFrequency = {}));
...
__decorate([
    (0, typeorm_1.OneToMany)(() => UserInteraction_1.UserInteraction, interaction => interaction.newsletter, { nullable: true }),
    __metadata("design:type", Array)
