            ...
            {Object.entries(colorPalette)
              ...
              .map(([name, colors]) => (
                <div key={name} className="flex items-center space-x-4">
                  <div className="w-16 h-16 rounded-lg" style={{ backgroundColor: colors.light }} />
                  <div>
      ...
      <div className="grid grid-cols-5 gap-2">
        {Object.entries(colorPalette.neutral).map(([key, color]) => (
          <div key={key} className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-lg" style={{ backgroundColor: color }} />
...
ColorPaletteGuide.parameters = {
  docs: {
    description: {
      component:
        "Comprehensive color palette showcasing the application's design system with light and dark theme variations.",
    },
  },
};
