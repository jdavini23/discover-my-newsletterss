...
export const SelectedFilters: Story = () => <SearchFilters 
  onApplyFilters={() => {}} 
  initialFilters={{
...
export const ManyCategories: Story = () => <SearchFilters 
  onApplyFilters={() => {}} 
  categories={[
...
export const EmptyState: Story = () => <SearchFilters 
  onApplyFilters={() => {}} 
  categories={[]}
  frequencies={[]}
/>;

export const DisabledState: Story = () => <SearchFilters 
  onApplyFilters={() => {}} 
  disabled={true}
/>;
