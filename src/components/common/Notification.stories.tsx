...
export const SuccessNotification = () => (
  <Notification type="success" message="Newsletter subscribed successfully!" />
);

export const ErrorNotification = () => (
  <Notification type="error" message="Failed to subscribe. Please try again." />
);

export const WarningNotification = () => (
  <Notification type="warning" message="Your subscription is about to expire" />
);

export const InfoNotification = () => <Notification type="info" message="New feature available" />;
