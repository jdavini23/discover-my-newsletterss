...
`,m=({children:e,variant:t="primary",size:a="md",...w})=>r.jsx(F,{variant:t,size:a,...w,children:e}),R={title:"Common/Button",component:m,argTypes:{variant:{control:{type:"select",options:["primary","secondary","accent"]}},size:{control:{type:"select",options:["sm","md","lg"]}},onClick:{action:"clicked"}},decorators:[(e,t)=>{const a=t.parameters.theme==="dark"?C:E;return r.jsx(P,{theme:a,children:r.jsx("div",{style:{padding:"20px",backgroundColor:a.colors.background,display:"flex",gap:"10px",flexWrap:"wrap"},children:r.jsx(e,{...t})})})}]},n={args:{children:"Primary Button",variant:"primary"}},s={args:{children:"Secondary Button",variant:"secondary"}},o={args:{children:"Accent Button",variant:"accent"}},c={render:()=>r.jsxs(r.Fragment,{children:[r.jsx(m,{size:"sm",children:"Small Button"}),r.jsx(m,{size:"md",children:"Medium Button"}),r.jsx(m,{size:"lg",children:"Large Button"})]})},i={args:{children:"Disabled Button",disabled:!0}},d={parameters:{theme:"dark"},args:{children:"Dark Theme Button"}};var l,u,h;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
...
}`,...(j=($=i.parameters)==null?void 0:$.docs)==null?void 0:j.source}}};var v,D,T;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  parameters: {
    theme: 'dark'
  },
  args: {
...
}`,...(T=(D=d.parameters)==null?void 0:D.docs)==null?void 0:T.source}}};const _=["Primary","Secondary","Accent","Sizes","Disabled","DarkTheme"];export{o as Accent,d as DarkTheme,i as Disabled,n as Primary,s as Secondary,c as Sizes,_ as __namedExportsOrder,R as default};
